...
2. Verify port 8766 is not blocked by firewall
...
│   ├── job_id/
│   │   ├── camera_0_analyzed.mp4      # Annotated video
│   │   ├── animation.mp4              # Clean DRS animation
│   │   ├── decision_report.pdf        # PDF report
│   │   ├── analysis.json              # Full data JSON
│   │   └── tracking.csv               # Tracking points CSV
│   └── ...
...
1. ✅ Test with 10-second synthetic video
2. ✅ Test with your own real cricket videos
3. ✅ Test multi-camera setup with 2-3 hours of data
4. ✅ Check accuracy gates and readiness status
